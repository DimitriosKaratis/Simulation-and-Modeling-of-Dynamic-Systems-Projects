...
function dx = roll_angle_dynamics_noise(t, x, a1, a2, a3, b, ...
    phi_0, phi_inf, lambda, rho, k1, k2, r_d, d, t_vec)
    ...
    dx(2) = -a1 * r_dot - a2 * sin(r) + a3 * r_dot^2 * sin(2 * r) + b * u + d_t;
end
